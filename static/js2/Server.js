...
export const Server = {
    ...
    init: function () {
        ...
        const socket = io("http://localhost:3001", { query: `uuid=${user.uuid}&room=${user.room}&nickname=${user.nickname}&pos=${JSON.stringify(user.pos)}&rot=${JSON.stringify(user.rot)}` });
        Users.me = user;
