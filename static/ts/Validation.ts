...
export function check(data:any[]):boolean|any{
...
export function checkName(data:string[]):boolean|any{
        if(
...
export function checkPos(data:any[]):boolean|any{
        if(
...
export function checkRot(data:any[]):boolean|any{
        if(
                !(Array.isArray(data) && data.length==4) ||
                !(typeof data[0] === "string" && data[0].length == 13) ||
                !(typeof data[1] === "number") ||
